    ...
    return (
        <div ref={containerRef} className="absolute inset-0">
            {slotPositions.map((slot, index) => {
                const x =
                    (slot.x / imageSize.width) * displaySize.width +
                    displaySize.offsetX;
                const y =
                    (slot.y / imageSize.height) * displaySize.height +
                    displaySize.offsetY;
                const width =
                    (slot.width / imageSize.width) * displaySize.width;
                const height =
                    (slot.height / imageSize.height) * displaySize.height;
